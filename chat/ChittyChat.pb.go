...
//
//protoc --go_out=plugins=grpc:chat ChittyChat.proto
//protoc --go-grpc_out=grpc:chat ChittyChat.proto
//
...
type ChatRoomMessages struct {
	...
	Timestamp int32  `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // TIMECHAR: Turn this into a timestamp object= 2;
